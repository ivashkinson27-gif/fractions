...
void conversion() {
    ...
    std::cout << a.str() << " double: " << a_double << std::endl;

}

void expressions() {

    Rational result = (Rational(1, 6) + Rational(1, 4)) *
        (Rational(2, 5) - Rational(4, 3)) /
        Rational(5, 10);
...
void reduction() {
    ...
    std::cout << "9/36 = " << a.str() << std::endl;
    std::cout << "21/49 = " << b.str() << std::endl;
